...
- (UITableView *)ex_superTableView
{
    ...
    if (self.superview) {
        UITableView * tableView= [self.superview ex_superTableView];
        if (tableView != nil) {
            return tableView;
        }
    }
...
- (UITableViewCell*)ex_superTableCell
{
    ...
    if (self.superview) {
        UITableViewCell  * tableViewCell = [self.superview ex_superTableCell];
...
- (UIView *)ex_findFirstResponder
{
    ...
    for (UIView *subView in self.subviews) {
        UIView *firstResponder = [subView ex_findFirstResponder];
